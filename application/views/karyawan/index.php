    ...
    <div id="content" class="col-md-10 col-xs-8 col-sm-9">
				...
				<div id="panel" class="panel panel-info">
					<div class="panel-heading"> 
						<h3 class="panel-title"> <span class="glyphicon glyphicon-user"></span> Show Data Karyawan </h3>
					 </div>
					 <div class="panel-body">

<a id="tam_dat" class="btn btn-info btn-sm" href="<?=base_url();?>karyawan/tambah"> <span class="glyphicon glyphicon-plus"></span> Tambah Data</a> <br/>

     <?= " <span style='color:#000;'> ".$this->session->flashdata('pesan')."</span>"; ?>  <!-- Notifikasi Flashdata-->
					 	...
					 	<table border="1" class="table table-bordered">
                            ...
                            <?php
                                foreach($s_karyawan as $karyawan):
                            ?>
